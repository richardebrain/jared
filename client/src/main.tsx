...
import { fixAuthenticationLoop } from "./lib/auth-fix";

// Apply authentication loop fix to prevent infinite update cycles
try {
  fixAuthenticationLoop();
} catch (error) {
  console.error("Failed to apply authentication loop fix:", error);
}
