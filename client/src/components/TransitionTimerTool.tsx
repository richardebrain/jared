...
export default function TransitionTimerTool() {
  ...
  return (
    <div className="w-full">
      ...
      {/* Timer Setup - shown when timer is not active */}
      {!timerActive && (
      ...
      {timerActive && (
        <div className="flex flex-col items-center justify-center w-full space-y-6">
          ...
          <div className="relative w-48 h-64 mb-6 transition-all duration-500">
            {/* Hourglass top */}
            <div className="absolute top-0 left-0 right-0 h-[calc(50%-3px)] 
                          bg-gray-100 border-2 border-gray-600 rounded-t-2xl 
              ...
              <div 
                ...
                style={{ 
                  ...
                  boxShadow: `0 -10px 15px -5px rgba(0,0,0,0.1) inset`
                }}
              ></div>
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 
                          w-8 h-4 bg-gradient-to-br from-gray-600 to-gray-500 z-10
                          shadow-md"></div>
            
            {/* Hourglass bottom */}
            <div className="absolute bottom-0 left-0 right-0 h-[calc(50%-3px)] 
                          bg-gray-100 border-2 border-gray-600 rounded-b-2xl 
                          overflow-hidden shadow-inner">
              <div 
            ...
            {timerActive && (
              <>
                ...
                ></div>
                <div 
                  className="absolute top-1/2 left-[calc(50%-2px)] transform 
                            w-[1px] animate-sand-fall-slow"
                  style={{
                    height: '20%',
                    backgroundColor: getSandColor(),
