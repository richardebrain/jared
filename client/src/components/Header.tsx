    ...
    <header className="sticky top-0 bg-white shadow-md z-50">
      <div className="max-w-7xl mx-auto px-2 py-2 flex justify-between items-center">
        <div className="flex items-center">
          <Link href="/">
            <div className="flex items-center">
              <img src={raisingArizonaLogo} alt="Raising Arizona Preschool" className="h-10 mr-2 rounded-md shadow-sm" />
        ...
        <nav className="hidden md:flex items-center bg-amber-50 rounded-full px-2 shadow-inner max-w-[600px] overflow-x-auto">
          <Link href="/">
            <div className={`whitespace-nowrap font-medium px-3 py-1.5 rounded-full mx-1 text-xs ${location === "/" 
          ...
          <Link href="/progression-map">
            <div className={`whitespace-nowrap font-medium px-3 py-1.5 rounded-full mx-1 text-xs ${location === "/progression-map" 
              ? "bg-amber-600 text-white shadow-sm" 
              : "text-neutral-700 hover:bg-amber-100"} transition-all duration-200 cursor-pointer`}>
              Progression
            </div>
          ...
          <Link href="/assessment">
            <div className={`whitespace-nowrap font-medium px-3 py-1.5 rounded-full mx-1 text-xs ${location === "/assessment" 
              ? "bg-amber-600 text-white shadow-sm" 
              : "text-neutral-700 hover:bg-amber-100"} transition-all duration-200 cursor-pointer`}>
              Assessment
            </div>
          ...
          <Link href="/tools">
            <div className={`whitespace-nowrap font-medium px-3 py-1.5 rounded-full mx-1 text-xs ${location === "/tools" 
              ? "bg-amber-600 text-white shadow-sm" 
              : "text-neutral-700 hover:bg-amber-100"} transition-all duration-200 cursor-pointer`}>
              Tools
            </div>
          ...
          <Link href="/video-resources">
            <div className={`whitespace-nowrap font-medium px-3 py-1.5 rounded-full mx-1 text-xs ${location === "/video-resources" 
              ? "bg-amber-600 text-white shadow-sm" 
              : "text-neutral-700 hover:bg-amber-100"} transition-all duration-200 cursor-pointer`}>
              Videos
            </div>
