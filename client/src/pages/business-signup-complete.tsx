...
// New improved business signup component that uses a single server endpoint
export default function BusinessSignupComplete() {
        ...
        <div className="max-w-3xl mx-auto">
          <Card className="w-full">
            <CardHeader className="text-center">
              <CardTitle className="text-3xl">School Registration</CardTitle>
              <CardDescription>
                Register your school and create your administrator account
              </CardDescription>
            </CardHeader>
