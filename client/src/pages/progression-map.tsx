      ...
      <main className="flex-1 container mx-auto p-4 md:p-6">
        <div className="space-y-8">
          ...
          <Card className="bg-gradient-to-r from-amber-50 to-yellow-50 border-amber-200">
            <CardHeader>
              <CardTitle className="text-center text-xl font-bold text-amber-800 flex items-center justify-center gap-2">
                <TrendingUp className="h-6 w-6" />
                Understanding Your Points System
              </CardTitle>
              <CardDescription className="text-center text-amber-700">
                Learn how points work and what they mean for your progress
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h4 className="font-semibold text-blue-800">Current Points</h4>
                  </div>
                  <div className="text-2xl font-bold text-blue-600 mb-2">{userData?.points || user?.points || 0}</div>
                  <p className="text-sm text-blue-700">
                    Your <strong>spendable balance</strong> for converting to Bear Bucks or purchasing rewards. 
                    These points decrease when you spend them but increase when you earn new ones.
                  </p>
                </div>
                ...
                <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h4 className="font-semibold text-purple-800">Lifetime Points</h4>
                  </div>
                  <div className="text-2xl font-bold text-purple-600 mb-2">{userData?.lifetimePoints || user?.lifetimePoints || 0}</div>
                  <p className="text-sm text-purple-700">
                    Your <strong>total earned points</strong> used for level progression and achievements. 
                    These points <strong>never decrease</strong> and track your overall learning progress.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-amber-100 p-4 rounded-lg border border-amber-300">
                ...
                <ul className="text-sm text-amber-800 space-y-1">
                  <li><strong>Current Points:</strong> Can be spent on Bear Bucks and rewards - your "wallet"</li>
                  <li><strong>Lifetime Points:</strong> Determine your teacher level and never go down - your "experience"</li>
                  <li><strong>When you convert points to Bear Bucks:</strong> Current points decrease, lifetime points stay the same</li>
                  <li><strong>When you earn new points:</strong> Both current and lifetime points increase together</li>
                </ul>
              </div>
              
              {(userData?.points || user?.points || 0) > (userData?.lifetimePoints || user?.lifetimePoints || 0) && (
                <div className="bg-orange-100 p-4 rounded-lg border border-orange-300">
                  <h4 className="font-semibold text-orange-800 mb-2">Notice About Your Points</h4>
                  <p className="text-sm text-orange-700">
                    Your current points ({userData?.points || user?.points || 0}) are higher than your lifetime points ({userData?.lifetimePoints || user?.lifetimePoints || 0}). 
                    This can happen due to data migration or system updates. Your lifetime points should be updated to reflect your total earned points.
                  </p>
                </div>
              )}
            </CardContent>
