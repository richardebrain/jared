...
export default function LearningModulePage() {
  ...
  console.log(module,'module fetched')
  ...
  const moduleSections = useMemo(() => {
    ...
    try {
      ...
      console.log(parsed,'parsed module')
  ...
  const [scenarioMatches, setScenarioMatches] = useState<{
    [sectionIndex: number]: { [scenarioIndex: number]: number | null };
  }>({});
  ...
  const checkMatches = (
    ...
    const allMatched =
      Object.keys(sectionMatches).length === scenarioCount &&
    ...
    if (!allMatched) {
      toast({
        ...
        description:
          "Please match all scenarios with responses before checking your answers.",
        variant: "destructive",
      });
      return;
    }
    ...
    Object.entries(sectionMatches).forEach(([scenarioIdx, responseIdx]) => {
      ...
      if (isCorrect) {
        correctCount++;
        explanations.push(
          `Scenario ${parseInt(scenarioIdx) + 1} → Response ${String.fromCharCode(65 + responseIdx!)} ✓ This is the developmentally appropriate response that follows evidence-based practices.`,
        );
      } else {
        explanations.push(
          `Scenario ${parseInt(scenarioIdx) + 1} → Response ${String.fromCharCode(65 + responseIdx!)} ✗ Consider a response that is more developmentally appropriate and builds on positive guidance strategies.`,
        );
      }
    });
                                ...
                                <div className="bg-green-50 border border-green-200 rounded-lg p-6">
                                  ...
                                  {(() => {
                                    ...
                                    return contentData?.scenarios &&
                                                  ...
                                                  onClick={() => {
                                                    ...
                                                    if (nextSection) {
                                                      ...
                                                      setTimeout(() => {
                                                        const nextElement =
                                                          document.querySelector(
                                                            `[data-section-index="${currentIndex + 1}"]`,
                                                          );
                                                        if (nextElement) {
                                                      ...
                                                      toast({
                                                        title: "Great Job!",
                                                        description:
                                                          "Moving to the next section of the module.",
                                                      });
                                                    } else {
                                                      // Complete module
                                                      toast({
                                                        title:
                                                          "Module Complete!",
                                                        description:
                                                          "You've finished all sections. Well done!",
                                                      });
                                                    }
                                                  }}
                                      ...
                                      <div className="text-gray-600">
                                        <p>
                                          Match classroom scenarios with
                                          appropriate teacher responses.
                                        </p>
                                        <div className="mt-4 text-sm">
                                          {typeof section.content === "string"
                                            ? section.content
                                            : "Interactive scenario matching activity"}
                                        </div>
                                      </div>
                                    );
                                  })()}
                                  ...
                                  <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded">
                                    <p className="text-sm text-yellow-700">
                                      ...
                                      Review each scenario and identify which
                                      response would be most appropriate.
                                      Consider developmental appropriateness and
                                ...
                                module.title.includes("Breathing") ? (
                                  <>
                                    <div className="mb-4">
                                      ...
                                      effectively teach breathing exercises to
                                      children that can help them regulate their
                                      emotions and increase focus in the
                                      classroom.
                                    </div>
                                    ...
                                    <ul className="list-disc pl-5 mb-4 space-y-1">
                                      <li>
                                        Helps children develop self-regulation
                                        skills
                                      </li>
                                      <li>
                                      ...
                                      <li>
                                        Can be used as a transitional activity
                                        between lessons
                                      </li>
                                    </ul>

                                    <div className="p-4 bg-[#e6ecff] border border-[#0030b8] rounded-lg mb-6">
                                      <div className="font-semibold text-[#0030b8]">
                                        🌟 Easter Egg Alert!
                                      </div>
                                      <div className="text-[#333]">
                                        ...
                                        " and share it with your director,
                                        you'll receive a special lunch reward!
                                      </div>
                                    </div>
                                  </>
                                  ...
                                  <>
                                    <div className="mb-4">
                                      This module explores how to teach children
                                      positive self-talk and affirmations that
                                      build confidence and resilience in the
                                      classroom setting.
                                    </div>

                                    <h5 className="font-semibold mt-6 mb-2">
                                      Benefits of Self-Affirmations for Children
                                    </h5>
                                    <ul className="list-disc pl-5 mb-4 space-y-1">
                                      <li>
                                        Builds a positive self-image and
                                        self-esteem
                                      </li>
                                      <li>
                                        Encourages resilience when facing
                                        challenges
                                      </li>
                                      <li>
                                        Helps develop a growth mindset approach
                                        to learning
                                      </li>
                                      <li>
                                    ...
                                    <div className="p-4 bg-[#e6ecff] border border-[#0030b8] rounded-lg mb-6">
                                      ...
                                      <div className="text-[#333]">
                                        Create your own classroom affirmation
                                        and send it to your director to receive
                                        special recognition in the next staff
                                        meeting!
                                      </div>
                                    </div>
                                  </>
                                  ...
                                  <>
                                    <div className="mb-4">
                                      The gratitude module will help you
                                      incorporate thankfulness and appreciation
                                      practices into your daily classroom
                                      routines.
                                    </div>
                                    ...
                                    <ul className="list-disc pl-5 mb-4 space-y-1">
                                      <li>
                                        Improves classroom climate and student
                                        well-being
                                      </li>
                                      <li>
                                        Helps children develop emotional
                                        intelligence
                                      </li>
                                      <li>
                                        Reduces conflicts and promotes empathy
                                      </li>
                                      <li>
                                    ...
                                    <div className="p-4 bg-[#e6ecff] border border-[#0030b8] rounded-lg mb-6">
                                      ...
                                      <div className="text-[#333]">
                                        Find the three gratitude statements
                                        embedded in this module. When you find
                                        all three, share them with your director
                                        to unlock a special reward!
                                      </div>
                                    </div>
                                  </>
                                )
                                  ...
                                  "Raising Arizona's CORE Values" ? (
                                    <>
                                      <h3 className="text-xl font-semibold mb-4">
                                        CORE Values at Raising Arizona
                                      </h3>
                                      <p className="mb-4">
                                        Our CORE values guide everything we do
                                        at Raising Arizona Preschool. These
                                        fundamental principles help create a
                                        nurturing environment where children and
                                        staff can thrive together.
                                      </p>
                                      ...
                                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                        <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                                          ...
                                          <p>
                                            We show kindness and empathy to
                                        ...
                                        <div className="bg-green-50 p-4 rounded-lg border border-green-200">
                                          ...
                                          <p>
                                            We create meaningful learning
                                            opportunities that inspire curiosity
                                            and growth for both children and
                                            staff.
                                          </p>
                                        </div>
                                        <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
                                          ...
                                          <p>
                                            We honor the dignity and worth of
                                            every child, family member, and
                                            colleague through our words and
                                            actions.
                                          </p>
                                        </div>
                                        <div className="bg-amber-50 p-4 rounded-lg border border-amber-200">
                                          ...
                                          <p>
                                            ...
                                            aspects of our work, continuously
                                            improving our practices to provide
                                      ...
                                      <h3 className="text-xl font-semibold mb-3 mt-6">
                                        Miss Rosa's Unbroken Circle
                                      </h3>
                                      <div className="bg-gray-50 p-5 rounded-lg border border-gray-200 mb-6">
                                        <p className="italic text-gray-700 mb-4">
                                          From the very first morning, Lila
                                          clung to the classroom door, eyes wide
                                          with fear. Miss Rosa approached
                                          slowly, kneeling to meet Lila's gaze.
                                          "Would you like to help me with our
                                          welcome song this morning?" she
                                          whispered. Lila's grip loosened
                                          slightly.
                                        </p>
                                        <p className="italic text-gray-700 mb-4">
                                          Each day, Miss Rosa invited Lila to
                                          help in small ways—watering plants,
                                          arranging cushions for circle time,
                                          choosing the morning book. Miss Rosa
                                          noticed Lila's careful attention to
                                          how things were arranged—her natural
                                          sense of order.
                                        </p>
                                        <p className="italic text-gray-700 mb-4">
                                          "In our classroom," Miss Rosa
                                          explained to her colleagues, "we
                                          respect each child's journey. Lila
                                          needs to feel safe before she can
                                          fully participate." By month's end, it
                                          was Lila who organized the welcome
                                          circle, carefully placing each cushion
                                          in a perfect round formation, ensuring
                                          no child was left outside the circle.
                                        </p>
                                        <p className="italic text-gray-700">
                                          What Miss Rosa recognized in this
                                          child was the need for inclusion
                                          through meaningful contribution. By
                                          honoring Lila's need for order and
                                          giving her purpose, Miss Rosa
                                          demonstrated how our CORE values
                                          create an unbroken circle where every
                                          child belongs.
                                        </p>
                                      </div>

                                      <h3 className="text-xl font-semibold mb-3 mt-6">
                                        Ms. Elena's Whispered Promise
                                      </h3>
                                      <div className="bg-gray-50 p-5 rounded-lg border border-gray-200 mb-6">
                                        <p className="italic text-gray-700 mb-4">
                                          Tiny footsteps echoed in the
                                          cubby-lined hallway as four-year-old
                                          Jamal arrived early each morning. His
                                          father, working double shifts, would
                                          drop him off before sunrise. Rather
                                          than seeing this as an inconvenience,
                                          Ms. Elena recognized an opportunity.
                                        </p>
                                        <p className="italic text-gray-700 mb-4">
                                          "Jamal, would you like to be my
                                          special classroom helper this
                                          morning?" she asked that first day.
                                          His eyes lit up as she handed him a
                                          small spray bottle and cloth.
                                          Together, they wiped tables and
                                          arranged chairs before other children
                                          arrived.
                                        </p>
                                        <p className="italic text-gray-700 mb-4">
                                          The early-morning ritual continued for
                                          months. One day, Jamal's father
                                          arrived later than usual, apologizing
                                          profusely. Ms. Elena noticed Jamal
                                          whisper something to his father, who
                                          looked surprised but nodded. The next
                                          day, father and son arrived
                                          together—early again.
                                        </p>
                                        <p className="italic text-gray-700">
                                          "He told me he had important work to
                                          do," his father explained, smiling.
                                          "That you were counting on him." Ms.
                                          Elena nodded, understanding. Through
                                          her simple act of creating opportunity
                                          from challenge, she had given Jamal
                                          more than just tasks—she had given him
                                          purpose and pride, demonstrating that
                                          our CORE values provide every child
                                          the chance to excel in their own
                                          unique way.
                                        </p>
                                      </div>
                                      ...
                                      <div className="bg-gray-50 p-5 rounded-lg border border-gray-200 mb-6">
                                        <p className="mb-3">
                                          Listen to our CORE Values song and
                                          fill in the missing words:
                                        </p>

                                        <div className="mb-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                                          <p className="italic mb-2 text-gray-700 font-medium">
                                            Sunrise paints the Glendale sky
                                            gold,
                                          </p>
                                          <p className="italic mb-2 text-gray-700 font-medium">
                                            As we open our doors once more.
                                          </p>
                                          <p className="italic mb-2 text-gray-700 font-medium">
                                            At Raising Arizona we uphold
                                          </p>
                                          <p className="italic mb-2 text-gray-700 font-medium">
                                            The CORE values we all adore.
                                          </p>
                                          <p className="italic mt-3 text-gray-700 font-medium">
                                        ...
                                        <div className="bg-white p-4 rounded-lg border border-gray-300">
                                          <p className="mb-4 font-medium">
                                            Fill in the missing CORE values:
                                          </p>
                                          <div className="mb-6">
                                            <p className="mb-2">
                                              C stands for{" "}
                                              <input
                                                type="text"
                                                className="border-b-2 border-blue-500 bg-transparent px-1 w-28 focus:outline-none"
                                            ...
                                            <p className="mb-2">
                                              ...
                                              <input
                                                type="text"
                                                className="border-b-2 border-green-500 bg-transparent px-1 w-28 focus:outline-none"
                                                placeholder="type here..."
                                              />{" "}
                                            ...
                                            <p className="mb-2">
                                              ...
                                              <input
                                                type="text"
                                                className="border-b-2 border-purple-500 bg-transparent px-1 w-28 focus:outline-none"
                                                placeholder="type here..."
                                              />{" "}
                                              for everyone
                                            </p>
                                            <p className="mb-4">
                                              ...
                                              <input
                                                type="text"
                                                className="border-b-2 border-amber-500 bg-transparent px-1 w-28 focus:outline-none"
                                                placeholder="type here..."
                                              />{" "}
                                          ...
                                          <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                                            ...
                                            <div className="text-sm text-yellow-700">
                                              ...
                                              Compassion, Opportunity, Respect,
                                              and Excellence. This interactive
                                              element helps children better
                                              remember our CORE values through
                                      ...
                                      <div className="p-4 bg-[#e6ecff] border border-[#0030b8] rounded-lg mb-6">
                                        ...
                                        <div className="text-[#333]">
                                          There's a special phrase hidden in
                                          Miss Rosa's story. Find it and share
                                          it with your director to earn 50 bonus
                                          points!
                                        </div>
                                      </div>
                                    </>
                                    ...
                                    <>
                                      This is where the specific lesson content
                                      would be displayed, including text
                                      explanations, interactive elements, and
                                      practice exercises.
                                      <div className="p-4 bg-muted rounded-lg mt-4">
                                        <p className="text-center text-muted-foreground">
                                          Lesson content is loaded dynamically
                                          based on the selected module and
                                          lesson.
                                        </p>
                                      </div>
                                    </>
                    ...
                    <div>
                                ...
                                <div className="flex items-center justify-between">
                                  <div>
                                    <h5 className="font-medium text-gray-900">
                                      {quizSection.title || `Quiz ${index + 1}`}
                                    </h5>
                      ...
                      <div className="space-y-3 mb-6">
                        {moduleLessons.map((lesson, index) => {
                          ...
                          const progressPerLesson = 100 / moduleLessons.length;
                          const isComplete =
                            currentProgress >= (index + 1) * progressPerLesson;
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    <div className="flex justify-between mb-1 text-sm">
                      ...
                      <span className="font-semibold">
                        {Math.floor((module.duration * currentProgress) / 100)}{" "}
                        min
                      </span>
                    </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-sm mb-4">
                      I'm AI Beary, your teaching assistant! Ask me anything
                      about this module, classroom strategies, or early
                      childhood education.
                    </p>
