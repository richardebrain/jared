                                ...
                                <div className="space-y-6">
                                  ...
                                  {moduleSections[currentSectionIndex] && (
                                    ...
                                    >
                                      ...
                                      {/* Mnemonic Section */}
                                      {moduleSections[currentSectionIndex].type === "mnemonic" && (
                                        <div className="mb-6">
                                          <div className="bg-gradient-to-r from-pink-50 to-purple-50 border border-pink-200 rounded-lg p-6">
                                            <div className="flex items-center mb-4">
                                              ...
                                              <h3 className="text-lg font-semibold text-pink-800">Memory Techniques</h3>
                                            </div>
                                            {moduleSections[currentSectionIndex].builderData?.mnemonics ? (
                                              <div className="space-y-4">
                                                {moduleSections[currentSectionIndex].builderData.mnemonics.map((mnemonic: any, index: number) => (
                                                  <div key={index} className="bg-white rounded-lg p-4 border border-pink-100">
                                                    <h4 className="font-semibold text-pink-900 mb-2">{mnemonic.concept}</h4>
                                                    <div className="text-lg font-medium text-purple-700 mb-2">{mnemonic.mnemonic}</div>
                                                    <p className="text-gray-700 mb-2">{mnemonic.explanation}</p>
                                                    <div className="text-sm text-pink-600 bg-pink-50 rounded p-2">
                                                      <strong>Tip:</strong> {mnemonic.tip}
                                                    </div>
                                                  </div>
                                                ))}
                                              </div>
                                      ...
                                      {/* Scenario Section */}
                                      {moduleSections[currentSectionIndex].type === "scenario" && (
                                        <div className="mb-6">
                                          <div className="bg-gradient-to-r from-blue-50 to-cyan-50 border border-blue-200 rounded-lg p-6">
                                            <div className="flex items-center mb-4">
                                              ...
                                              <h3 className="text-lg font-semibold text-blue-800">Interactive Scenarios</h3>
                                            </div>
                                            {moduleSections[currentSectionIndex].builderData?.scenarios ? (
                                              <div className="space-y-4">
                                                {moduleSections[currentSectionIndex].builderData.scenarios.map((scenario: any, index: number) => (
                                                  <div key={index} className="bg-white rounded-lg p-4 border border-blue-100">
                                                    <h4 className="font-semibold text-blue-900 mb-3">{scenario.title}</h4>
                                                    <p className="text-gray-700 mb-4">{scenario.context}</p>
                                                    <div className="space-y-2">
                                                      <h5 className="font-medium text-gray-800">Response Options:</h5>
                                                      {scenario.options?.map((option: any, optIndex: number) => (
                                                        <div key={optIndex} className="bg-gray-50 rounded p-3 border-l-4 border-blue-300">
                                                          <div className="font-medium text-gray-800">{option.text}</div>
                                                          <div className="text-sm text-gray-600 mt-1">{option.outcome}</div>
                                                        </div>
                                                      ))}
                                                    </div>
                                                  </div>
                                      ...
                                      {/* Simulation Section */}
                                      {moduleSections[currentSectionIndex].type === "simulation" && (
                                        <div className="mb-6">
                                          <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg p-6">
                                            <div className="flex items-center mb-4">
                                              ...
                                              <h3 className="text-lg font-semibold text-green-800">Role-Play Simulation</h3>
                                            </div>
                                            {moduleSections[currentSectionIndex].builderData?.steps ? (
                                              <div className="space-y-4">
                                                {moduleSections[currentSectionIndex].builderData.steps.map((step: any, index: number) => (
                                                  <div key={index} className="bg-white rounded-lg p-4 border border-green-100">
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                                      <div className="bg-blue-50 rounded p-3">
                                                        <h5 className="font-medium text-blue-800 mb-1">Action</h5>
                                                        <p className="text-sm text-blue-700">{step.action}</p>
                                                      </div>
                                                      <div className="bg-purple-50 rounded p-3">
                                                        <h5 className="font-medium text-purple-800 mb-1">Expected Outcome</h5>
                                                        <p className="text-sm text-purple-700">{step.outcome}</p>
                                                      </div>
                                                    </div>
                                                    {step.feedback && (
                                                      <div className="mt-3 bg-yellow-50 rounded p-3 border-l-4 border-yellow-300">
                                                        <h5 className="font-medium text-yellow-800 mb-1">Feedback</h5>
                                                        <p className="text-sm text-yellow-700">{step.feedback}</p>
                                                      </div>
                                                    )}
                                                  </div>
                                                ))}
                                      ...
                                      {/* Slide Section */}
                                      {moduleSections[currentSectionIndex].type === "slide" && (
                                        <div className="mb-6">
                                          <div className="bg-gradient-to-r from-indigo-50 to-blue-50 border border-indigo-200 rounded-lg p-6">
                                            <div className="flex items-center mb-4">
                                              ...
                                              <h3 className="text-lg font-semibold text-indigo-800">Interactive Slides</h3>
                                            </div>
                                            {moduleSections[currentSectionIndex].builderData?.slides ? (
                                              <div className="space-y-4">
                                                {moduleSections[currentSectionIndex].builderData.slides.map((slide: any, index: number) => (
                                                  <div key={index} className="bg-white rounded-lg p-6 border border-indigo-100 shadow-sm">
                                                    <div className="flex items-center justify-between mb-3">
                                                      <h4 className="font-semibold text-indigo-900">{slide.title}</h4>
                                                    ...
                                                    {slide.notes && (
                                                      <div className="mt-3 bg-indigo-50 rounded p-3 border-l-4 border-indigo-300">
                                                        <h5 className="font-medium text-indigo-800 mb-1">Speaker Notes</h5>
                                                        <p className="text-sm text-indigo-700">{slide.notes}</p>
                                                      </div>
                                                    )}
                                                  </div>
                                                ))}
                                      ...
                                      {/* Example Section */}
                                      {moduleSections[currentSectionIndex].type === "example" && (
                                        <div className="mb-6">
                                          <div className="bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-lg p-6">
                                            <div className="flex items-center mb-4">
                                              ...
                                              <h3 className="text-lg font-semibold text-yellow-800">Practical Examples</h3>
                                            </div>
                                            {moduleSections[currentSectionIndex].builderData?.examples ? (
                                              <div className="space-y-4">
                                                {moduleSections[currentSectionIndex].builderData.examples.map((example: any, index: number) => (
                                                  <div key={index} className="bg-white rounded-lg p-4 border border-yellow-100">
                                                    <h4 className="font-semibold text-yellow-900 mb-3">{example.title}</h4>
                                                    <p className="text-gray-700 mb-3">{example.description}</p>
                                                    <div className="bg-amber-50 rounded p-3">
                                                      <h5 className="font-medium text-amber-800 mb-2">Implementation</h5>
                                                      <p className="text-sm text-amber-700">{example.implementation}</p>
                                                    </div>
                                                    {example.outcome && (
                                                      <div className="mt-3 bg-green-50 rounded p-3 border-l-4 border-green-300">
                                      ...
                                      {/* Matching Section */}
                                      {moduleSections[currentSectionIndex].type === "matching" && (
                                        <div className="mb-6">
                                          <div className="bg-gradient-to-r from-teal-50 to-cyan-50 border border-teal-200 rounded-lg p-6">
                                            <div className="flex items-center mb-4">
                                              ...
                                              <h3 className="text-lg font-semibold text-teal-800">Matching Activity</h3>
                                            </div>
                                                  ...
                                                  <div key={index} className="bg-white rounded-lg p-4 border border-teal-100">
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                      <div className="bg-teal-50 rounded p-3">
                                                        <h5 className="font-medium text-teal-800 mb-2">Term/Concept</h5>
                                                        <p className="text-sm text-gray-700">{pair.term || pair.left}</p>
                                                      </div>
                                                      <div className="bg-cyan-50 rounded p-3">
                                                        <h5 className="font-medium text-cyan-800 mb-2">Definition/Match</h5>
                                                        <p className="text-sm text-gray-700">{pair.definition || pair.right}</p>
                                                      </div>
                                                    </div>
                                                  </div>
                                                ))}
                                      ...
                                      {/* Triage Section */}
                                      {moduleSections[currentSectionIndex].type === "triage" && (
                                        <div className="mb-6">
                                          <div className="bg-gradient-to-r from-red-50 to-pink-50 border border-red-200 rounded-lg p-6">
                                            <div className="flex items-center mb-4">
                                              ...
                                              <h3 className="text-lg font-semibold text-red-800">Priority Triage</h3>
                                            </div>
                                            {moduleSections[currentSectionIndex].builderData?.items ? (
                                              <div className="space-y-3">
                                                {moduleSections[currentSectionIndex].builderData.items.map((item: any, index: number) => (
                                                  <div key={index} className="bg-white rounded-lg p-4 border border-red-100">
                                                    <div className="flex items-start gap-3">
                                                      ...
                                                      <div className="flex-1">
                                                        <h4 className="font-semibold text-gray-900 mb-2">{item.title || item.situation}</h4>
                                                        <p className="text-gray-700 text-sm mb-2">{item.description || item.details}</p>
                                                        {item.action && (
                                                          <div className="bg-blue-50 rounded p-2">
                                                            <h5 className="font-medium text-blue-800 text-xs mb-1">Recommended Action</h5>
                                                            <p className="text-blue-700 text-xs">{item.action}</p>
                                                          </div>
                                                        )}
                                                      </div>
                                                    </div>
