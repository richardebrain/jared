    ...
    const contentBlocks = [
      {
        ...
        preview: `Latest research findings about ${req.body.topic} in early childhood settings...`,
        content: `## Current Research on ${req.body.topic}\n\nRecent studies in early childhood education have revealed important insights about ${req.body.topic} that directly impact your daily practice.\n\n**Key Finding:** Children experiencing ${req.body.topic} show significant improvement when educators use specific, evidence-based approaches rather than generic classroom management techniques.\n\n**What This Means for You:** Your response to ${req.body.topic} situations should be tailored to the specific context and individual child's needs. Research shows that understanding the underlying causes of ${req.body.topic} leads to more effective interventions.\n\n**Implementation Strategy:**\n1. Observe patterns related to ${req.body.topic} in your classroom\n2. Document what triggers ${req.body.topic} behaviors or situations\n3. Apply targeted strategies based on current research\n4. Monitor outcomes and adjust approaches as needed\n\nThis research-backed approach to ${req.body.topic} creates more positive outcomes for both children and educators.`
      },
      {
        type: "Quick Strategy",
        preview: `Immediate technique for handling ${req.body.topic} situations...`,
        content: `## The 30-Second ${req.body.topic} Strategy\n\nWhen ${req.body.topic} appears in your classroom, you need an immediate, effective response.\n\n**The Strategy:** The "Pause, Assess, Respond" approach specifically designed for ${req.body.topic} situations.\n\n**Step 1 - Pause (5 seconds):** Take a breath and resist the urge to react immediately to ${req.body.topic}.\n\n**Step 2 - Assess (10 seconds):** Quickly evaluate what's driving the ${req.body.topic} behavior or situation.\n\n**Step 3 - Respond (15 seconds):** Use a targeted approach based on your assessment of the ${req.body.topic} context.\n\n**Your Script for ${req.body.topic}:**\n- "I notice you're dealing with ${req.body.topic}. Let's work through this together."\n- "I can see ${req.body.topic} is challenging right now. What do you need?"\n- "Let's find a way to handle ${req.body.topic} that works for everyone."\n\n**Why This Works:** This approach addresses ${req.body.topic} directly while maintaining your calm and showing children you're equipped to handle challenging situations.`
      }
    ];
