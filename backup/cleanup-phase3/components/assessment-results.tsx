...
export default function AssessmentResultsPage() {
  ...
  const getDomainName = (domain: string) => {
    switch (domain) {
      case "core":
        return "Raising Arizona CORE Values";
      case "mindful":
        return "Mindful Morning";
      case "build":
        return "Building a Human (Ch.1)";
      case "language":
            ...
            <CardContent className="py-4">
              <div className="flex flex-col items-center justify-center py-12 gap-4">
                ...
                <p className="text-center text-muted-foreground max-w-md">
                  Complete the teacher assessment to get personalized learning
                  recommendations and track your teaching skill development.
                </p>
                <Button
                  className="mt-4"
  ...
  console.log(assessmentResults, "latest");
  if (!latestAssessment) {
    return (
      <div className="min-h-screen bg-neutral-50">
        <Header />
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-6 shadow-sm">
                ...
                <div className="flex items-end gap-2 mb-2">
                  <span
                    className={`text-4xl font-bold ${getScoreColor(latestAssessment.overallScore)}`}
                  >
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {latestAssessment.domainScores &&
                  Object.entries(latestAssessment.domainScores).map(
                    ([domain, data]) => (
                      <div
                        key={domain}
                      ...
                      >
                        <div
                          className={`rounded-full p-2 mr-3 ${getDomainBadgeColor(domain).replace("hover:bg-", "bg-")}`}
                        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="space-y-2">
                  {latestAssessment.strengthAreas &&
                    latestAssessment.strengthAreas.map((strength, index) => (
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {latestAssessment.growthAreas &&
                    latestAssessment.growthAreas.map((growth, index) => (
                      <li key={index} className="flex items-start gap-2">
        ...
        <Card className="shadow-md">
          <CardHeader>
            ...
            <CardDescription>
              Based on your assessment results, we recommend these modules to
              help you grow
            </CardDescription>
          </CardHeader>
          ...
          <CardContent>
            {isLoadingModules ? (
              ...
              <div className="text-center py-8">
                <p className="text-muted-foreground">
                  No specific module recommendations available. Explore the
                  learning modules from the dashboard.
                </p>
              </div>
            )}
          </CardContent>
